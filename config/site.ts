  ...
  testimonials: [
    {
      ...
      rating: 5,
      text: 'Richard was amazing to work with. He was able to come in same day, estimate for free, and identify the problem immediately and talk me through a solution. He even sent me videos with a full explanation for the attic! :) 10/10 Would recommend',
      serviceType: 'Attic Inspection & Repair',
      timeAgo: '1 week ago',
    },
    {
      name: 'Christopher D.',
      ...
      rating: 5,
      text: 'Richard came out and did an excellent job consulting me on my issue. I had a leak, and he quickly identified and addressed the problem. He also took the time to walk me through several other items around my home and provided helpful guidance. Richard is extremely professional, knowledgeable, and honest. He made sure to clearly explain exactly what was needed rather than just throwing out numbers. He broke down the costs and explained why each expense was necessary for both labor and materials. He completed the work thoroughly and efficiently. I will definitely be using his services again in the future and highly recommend their services. This company is a Onestop shop!',
    ...
    },
    {
      ...
      location: 'Metro Atlanta, GA',
      rating: 5,
      text: 'HIRE RICHARD! He went above and beyond for my family. He identified issues that I did not know I had and addressed them for me. He triple-checked his work and made sure that I approved. He made thoughtful recommendations on future work as well. Moving forward, he will be my first and only call! TRUST ME- HIRE RICHARD!',
      serviceType: 'Sink & Faucet Installation',
      timeAgo: '3 weeks ago',
    },
    {
      name: 'Chris B.',
      location: 'Metro Atlanta, GA',
      rating: 5,
      text: 'He turned our unfinished closet with rotting floors and leaky pipe behind wall into clean, spacious, wonderful small office with plenty of neat storage. This room has always been an eyesore. We didn\'t even know we had a leak until he found and repaired it. So Thankful for his work.',
      serviceType: 'Closet to Office Conversion & Plumbing Repair',
      timeAgo: '3 weeks ago',
    },
    {
      name: 'Alison B.',
      location: 'Metro Atlanta, GA',
      rating: 5,
      text: 'Richard removed our old sink and vanity and replaced it with a new one. Like with most projects in an old home there was more damage than expected and Richard took care of it with no problems! Super kind, very knowledgeable, and very professional. We are looking forward to working with Richard on future renovations and projects!',
      serviceType: 'Sink & Vanity Replacement',
      timeAgo: '3 weeks ago',
    },
    {
      name: 'Jessica B.',
      location: 'Metro Atlanta, GA',
      rating: 5,
      text: 'Richard did an excellent job fixing my toilet and replacing the necessary parts to resolve the issue. He was very professional, arrived on time, and completed the job efficiently. Everything is working perfectly now. I would definitely hire him again in the future and highly recommend his services.',
