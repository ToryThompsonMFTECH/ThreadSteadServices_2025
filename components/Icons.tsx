  ...
  return (
    ...
    >
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={2}
        d="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655-5.653a2.548 2.548 0 010-3.586l4.94-4.94a2.548 2.548 0 013.586 0l5.653 4.655M11.42 15.17l-3.03 2.496a2.548 2.548 0 01-3.586 0l-4.94-4.94a2.548 2.548 0 010-3.586l4.655-5.653"
      />
    </svg>
  )
}
...
export function SquareIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function PaintBrushIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
