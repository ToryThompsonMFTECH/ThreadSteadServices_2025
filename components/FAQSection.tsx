...
export default function FAQSection() {
  ...
  return (
    <section className="relative py-20 px-4 bg-black overflow-hidden border-t border-white/10">
      <ParallaxOverlay image="/images/overlays/7.png" opacity={0.3} speed={0.34} />
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <div className="space-y-4">
          {siteConfig.faqs.map((faq, index) => (
            <div
              key={index}
              className="border-2 border-primary/20 rounded-lg overflow-hidden bg-white/95 backdrop-blur-sm shadow-md hover:shadow-lg transition-all"
            >
              <button
